...
Summary(es):	Utilitarios para mÛdulos y kerneld
Summary(fr):	Utiltaires de modules
Summary(pl):	NarzÍdzia do modu≥Ûw j±dra systemu bez kerneld
Summary(pt_BR):	Utilit·rios para mÛdulos e kerneld
Summary(ru):	ı‘…Ã…‘Ÿ ƒÃ— “¡¬œ‘Ÿ ” Õœƒ’Ã—Õ… —ƒ“¡
Summary(tr):	Mod¸l programlar˝
...
%description -l pl
Ten pakiet zawiera zestaw programÛw do wczytywania, wstawiania i
usuwania modu≥Ûw j±dra Linuksa (w wersji 2.5.47 i wyøszych). S≥uøy do
